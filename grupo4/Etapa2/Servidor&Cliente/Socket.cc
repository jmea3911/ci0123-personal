...
/**
  * CompletarConexion method
  *    para un Socket normal no hay ningun saludo que completar -- ya
  *    esta listo apenas se acepta la conexion TCP cruda
  *
 **/
VSocket * Socket::CompletarConexion( int fd ) {
